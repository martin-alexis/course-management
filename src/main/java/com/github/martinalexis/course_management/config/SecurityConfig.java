...
import com.github.martinalexis.course_management.auth.entryPoint.v1.CustomAuthenticationEntryPoint;
import com.github.martinalexis.course_management.auth.filter.v1.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity,
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/reviews/{idReview}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/courses/{idCourse}/reviews").permitAll()
